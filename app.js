...
async function outreach_pipeline() {
  try {
    ...
    // const domain = ['openai.com', 'google.com', 'microsoft.com', 'amazon.com', 'facebook.com'];
    ...
    // const confirmed = await outreachSummary(3, domain.length, personIds.length, personDataWithEmail);
